...
def generator_128(input, scope_name, reuse=False, skip=False):
	...
	with tf.variable_scope(scope_name, reuse=reuse):
		...
		d64 = ops.conv_instn_relu(c7s1_32, [3,3,32,64], 'd64', 2, 
								  padding="SAME")
		d128 = ops.conv_instn_relu(d64, [3,3,64,128], 'd128', 2,
								   padding="SAME")
		...
		u64 = ops.convt_instn_relu(r128_6, [3,3,64,128], tf.shape(d64), 'u64', 
								   2, padding="SAME")
		u64.set_shape(d64.get_shape().as_list())
		u32 = ops.convt_instn_relu(u64, [3,3,32,64], tf.shape(c7s1_32), 'u32', 
								   2, padding="SAME")
...
def generator_256(input, scope_name, reuse=False, skip=False):
	with tf.variable_scope(scope_name, reuse=reuse):
		...
		u64 = ops.convt_instn_relu(r128_9, [3,3,64,128], tf.shape(d64), 'u64', 
								   2, padding="SAME")
		u64.set_shape(d64.get_shape().as_list())
		u32 = ops.convt_instn_relu(u64, [3,3,32,64], tf.shape(c7s1_32), 'u32', 
								   2, padding="SAME")
