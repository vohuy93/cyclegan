...
# print(A_dis_loss_real.get_shape().as_list())
# print(A_dis_loss_fake.get_shape().as_list())
# print(A_dis_loss_fake_pool.get_shape().as_list())
# print(A_dis_loss.get_shape().as_list())

# print(B_dis_loss_real.get_shape().as_list())
# print(B_dis_loss_fake.get_shape().as_list())
# print(B_dis_loss_fake_pool.get_shape().as_list())
# print(B_dis_loss.get_shape().as_list())

# print(cycle_loss.get_shape().as_list())
# print(A_gen_loss.get_shape().as_list())
# print(B_gen_loss.get_shape().as_list())
# exit(0)
